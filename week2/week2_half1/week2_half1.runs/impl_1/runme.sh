...
HD_PWD='C:/Users/nohty/ECE_exp2/week2_half1/week2_half1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log week2_half1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source week2_half1.tcl -notrace
