...
HD_PWD='C:/git/ECE_exp2/week2/week2_gate/week2_gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week2_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week2_gate.tcl
