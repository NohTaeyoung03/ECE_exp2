...
HD_PWD='C:/git/ECE_exp2/week2/week2_gate/week2_gate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log week2_gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source week2_gate.tcl -notrace
