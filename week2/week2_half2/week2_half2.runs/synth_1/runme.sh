...
HD_PWD='C:/Users/nohty/ECE_exp2/week2_half2/week2_half2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week2_half2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week2_half2.tcl
