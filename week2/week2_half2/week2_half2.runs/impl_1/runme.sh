...
HD_PWD='C:/Users/nohty/ECE_exp2/week2_half2/week2_half2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log week2_half2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source week2_half2.tcl -notrace
