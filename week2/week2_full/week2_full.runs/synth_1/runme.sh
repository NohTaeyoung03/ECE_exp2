...
HD_PWD='C:/git/ECE_exp2/week2/week2_full/week2_full.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week2_full.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week2_full.tcl
