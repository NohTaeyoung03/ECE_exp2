...
HD_PWD='C:/git/ECE_exp2/week2/week2_full/week2_full.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log week2_full.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source week2_full.tcl -notrace
