...
HD_PWD='C:/git/ECE_exp2/week6/piezo/piezo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log piezo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source piezo.tcl -notrace
