...
HD_PWD='C:/git/ECE_exp2/week6/piezo/piezo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log piezo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source piezo.tcl
