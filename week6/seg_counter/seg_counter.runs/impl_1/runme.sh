...
HD_PWD='C:/git/ECE_exp2/week6/seg_counter/seg_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seg_counter.tcl -notrace
