...
HD_PWD='C:/git/ECE_exp2/week6/seg_counter/seg_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seg_counter.tcl
