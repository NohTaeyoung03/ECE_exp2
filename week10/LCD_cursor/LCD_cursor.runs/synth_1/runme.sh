...
HD_PWD='C:/git/ECE_exp2/week10/LCD_cursor/LCD_cursor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LCD_cursor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LCD_cursor.tcl
