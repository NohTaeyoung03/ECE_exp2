...
HD_PWD='C:/git/ECE_exp2/week10/LCD_cursor/LCD_cursor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LCD_cursor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LCD_cursor.tcl -notrace
