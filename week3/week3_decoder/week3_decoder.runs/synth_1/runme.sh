...
HD_PWD='C:/git/ECE_exp2/week3/week3_decoder/week3_decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week3_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week3_decoder.tcl
