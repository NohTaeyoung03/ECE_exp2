...
HD_PWD='C:/git/ECE_exp2/week3/week3_comparator/week3_comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log week3_comparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source week3_comparator.tcl -notrace
