...
HD_PWD='C:/git/ECE_exp2/week3/week3_encoder/week3_encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week3_encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week3_encoder.tcl
