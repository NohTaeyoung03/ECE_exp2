...
HD_PWD='C:/git/ECE_exp2/week5/diagram/diagram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log diagram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source diagram.tcl
