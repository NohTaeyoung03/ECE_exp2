...
HD_PWD='C:/git/ECE_exp2/week5/diagram/diagram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log diagram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source diagram.tcl -notrace
